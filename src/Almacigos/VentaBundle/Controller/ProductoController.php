...
use Almacigos\VentaBundle\Entity\Producto;
use Almacigos\VentaBundle\Form\ProductoType;
...
class ProductoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('VentaBundle:Producto')->findAll();
     ...
     * @Method("POST")
     * @Template("VentaBundle:Producto:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('VentaBundle:Producto')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("VentaBundle:Producto:edit.html.twig")
     */
