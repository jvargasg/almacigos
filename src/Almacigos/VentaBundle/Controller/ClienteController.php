...
use Almacigos\VentaBundle\Entity\Cliente;
use Almacigos\VentaBundle\Form\ClienteType;
...
class ClienteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('VentaBundle:Cliente')->findAll();
     ...
     * @Method("POST")
     * @Template("VentaBundle:Cliente:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('VentaBundle:Cliente')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("VentaBundle:Cliente:edit.html.twig")
     */
