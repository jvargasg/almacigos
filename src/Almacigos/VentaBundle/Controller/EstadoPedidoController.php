...
use Almacigos\VentaBundle\Entity\EstadoPedido;
use Almacigos\VentaBundle\Form\EstadoPedidoType;
...
class EstadoPedidoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('VentaBundle:EstadoPedido')->findAll();
     ...
     * @Method("POST")
     * @Template("VentaBundle:EstadoPedido:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('VentaBundle:EstadoPedido')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("VentaBundle:EstadoPedido:edit.html.twig")
     */
