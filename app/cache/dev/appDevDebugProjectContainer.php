...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            ...
            'kernel.bundles' => array(
                ...
                'UsuarioBundle' => 'Almacigos\\UsuarioBundle\\UsuarioBundle',
                'ParametrosBundle' => 'Almacigos\\ParametrosBundle\\ParametrosBundle',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => (dirname(dirname(dirname(__DIR__))).'/src/Almacigos/VentaBundle/Entity'), 1 => (dirname(dirname(dirname(__DIR__))).'/src/Almacigos/SiembraBundle/Entity'), 2 => (dirname(dirname(dirname(__DIR__))).'/src/Almacigos/UsuarioBundle/Entity'), 3 => (dirname(dirname(dirname(__DIR__))).'/src/Almacigos/ParametrosBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Almacigos\\VentaBundle\\Entity');
        $c->addDriver($b, 'Almacigos\\SiembraBundle\\Entity');
        $c->addDriver($b, 'Almacigos\\UsuarioBundle\\Entity');
        $c->addDriver($b, 'Almacigos\\ParametrosBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('VentaBundle' => 'Almacigos\\VentaBundle\\Entity', 'SiembraBundle' => 'Almacigos\\SiembraBundle\\Entity', 'UsuarioBundle' => 'Almacigos\\UsuarioBundle\\Entity', 'ParametrosBundle' => 'Almacigos\\ParametrosBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_591d0b5550c3fa105dea780519bd1e774d74280548fd8d08e43bb6ff14047df8');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/Almacigos/UsuarioBundle/Resources/views'), 'Usuario');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/Almacigos/ParametrosBundle/Resources/views'), 'Parametros');
