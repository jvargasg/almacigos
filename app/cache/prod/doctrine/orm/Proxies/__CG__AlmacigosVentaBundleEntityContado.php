 ...
 */
class Contado extends \Almacigos\VentaBundle\Entity\Contado implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Almacigos\\VentaBundle\\Entity\\Contado' . "\0" . 'id', '' . "\0" . 'Almacigos\\VentaBundle\\Entity\\Contado' . "\0" . 'iva', '' . "\0" . 'Almacigos\\VentaBundle\\Entity\\Contado' . "\0" . 'porcentajeDelTotal', '' . "\0" . 'Almacigos\\VentaBundle\\Entity\\Contado' . "\0" . 'condicionVenta');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Contado $proxy) {
    ...
    public function setPorcentajeDelTotal($porcentajeDelTotal)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPorcentajeDelTotal', array($porcentajeDelTotal));

        return parent::setPorcentajeDelTotal($porcentajeDelTotal);
    }
    ...
    public function getPorcentajeDelTotal()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPorcentajeDelTotal', array());

        return parent::getPorcentajeDelTotal();
    }
